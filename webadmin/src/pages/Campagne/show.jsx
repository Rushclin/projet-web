...
const ShowCampagne = () => {
    ...
    const getCampage = () => {
        axios
            .get("https://hanniel-api.herokuapp.com/hanniel/admin/campaign/" + id, {
                userId: user.userId,
                ...
                <Card>
                    <Grid container>
                        ...
                        <Grid item md={6} p={2} pt={4}>
                            ...
                            <Typography component="h3" variant="h6" style={{ textAlign: "center", paddingBottom: "10px" }}>
                                Detail sur la campagne
                            </Typography>

                            <hr />

                            <Typography variant="h6" component="p" style={{ fontSize: "15px", opacity: "0.5", paddingTop: "2px" }}>
                                Description de de la campagne
                            </Typography>
                            <Typography variant="h6" component="h3" style={{ fontSize: "12px", fontWeight: '100', paddingLeft: "10px", paddingBottom: "15px" }}>
                            ...
                            <Typography variant="h6" component="p" style={{ fontSize: "12px", opacity: "0.5", paddingTop: "2px" }}>
                                Nom de la campagne
                            </Typography>
                            <Typography variant="h6" component="h3" style={{ fontSize: "12px", fontWeight: '100', paddingLeft: "10px", paddingBottom: "15px" }}>
                                {campagne.name}
